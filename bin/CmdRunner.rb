...
CMD_SPECS = \
  {:banner => BANNER,
   ...
   :specs  => [
               ...
               ['foo', nil, "foo=4", Integer, false, "an optional integer option with default value of 4"],
               ['bar', nil, "bar", String, false, "an optional string option with no default value"],
